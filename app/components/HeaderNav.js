  ...
  return (
    <React.Fragment>
      ...
      {currentRoute == "/" ? (
        ...
        <div className="mt-4 md:mt-8 headline flex w-full flex-col justify-start items-start relative before:content-['~'] before:absolute before:left-[-.6em] before:top-[-.05em] text-2xlarge lg:text-3xlarge xl:text-4xlarge leading-[120%]">
