...
export default async function overview() {
  ...
  return (
    <div className="template_get-on-the-network container mb-[8rem] md:mb-[13.4rem] mt-12 overview-page">
      <div className="grid grid-cols-6 gap-x-4 w-full mb-16 text-25px">
