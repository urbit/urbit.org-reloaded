...
```sh
curl -O https://bootstrap.urbit.org/urbit-v0.10.6-linux64.tgz
tar xzf urbit-v0.10.6-linux64.tgz
cd urbit-v0.10.6-linux64
./urbit
```
...
If you are not already within the directory you installed above, enter it by running `cd urbit-v0.10.6-darwin` (for Mac) or `cd urbit-v0.10.6-linux64` (for Linux) from where you ran the install commands. It contains your Urbit binary, and your ship will be installed here as well.
