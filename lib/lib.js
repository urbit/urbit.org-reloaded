...
// Returns a time relative to the timezone in the iso8601 string
export function generateDisplayDate(iso8601) {
  return DateTime.fromISO(iso8601, { setZone: true });
}
...
export function formatTime(dateTimeObject) {
  return dateTimeObject.toLocaleString(DateTime.TIME_SIMPLE);
}

// Formats a DateTime object to something like "Jul 15, 2021"
export function formatDate(dateTimeObject) {
  return dateTimeObject.toLocaleString(DateTime.DATE_HUGE);
}
