...
/**
 * getLinksinSubdirs is written to provide a recursive index of posts
 * for nested directories for creating sidebars.
 * @param {string} path Absolute path to the subdirectory.
 * @returns {object} Nested object by directory with name of directory,
 * child pages (as an array of objects with title, .md filename, slug, and weight),
 * and subdirectories (named simply by the folder name). Iterate through the object
 * recursively.
 */
