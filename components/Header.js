	...
	return (
		<header className="layout-wide flex justify-between items-center pt-8">
		  ...
		  <nav className="flex items-center">
		  	<ActiveLink className="mr-5 type-ui" href="/docs">Docs</ActiveLink>
			<ActiveLink className="mr-5 type-ui" href="/blog">Blog</ActiveLink>
			<ActiveLink className="mr-5 type-ui" href="/events">Events</ActiveLink>
